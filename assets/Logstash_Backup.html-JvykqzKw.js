import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as e,o as i}from"./app-LM4D759t.js";const l={};function p(d,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<p>Logstash 简单试用备忘</p><h2 id="_1-从数据库里面输入开始试用" tabindex="-1"><a class="header-anchor" href="#_1-从数据库里面输入开始试用"><span>1. 从数据库里面输入开始试用</span></a></h2><p>看 <a href="https://www.elastic.co/blog/logstash-jdbc-input-plugin" target="_blank" rel="noopener noreferrer">官网相关的教学blog</a> 后用自己的 Mysql 测试</p><h3 id="_1-1-mysql" tabindex="-1"><a class="header-anchor" href="#_1-1-mysql"><span>1.1. Mysql</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>mysql_to_elasticsearch.conf</span></span>
